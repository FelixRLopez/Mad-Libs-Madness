...
function formValue(id) {
  // This gets an element from the HTML with the value of id
  let formElement = document.getElementById(id);
  
  // This checks if the element exists and if it does not, it returns an error message.
  if (formElement === null) {
    return `[${id} NOT FOUND]`;
  }
  ...
  let value = formElement.value;
	...
	// This checks if the value is empty and if it is, it returns a placeholder.
